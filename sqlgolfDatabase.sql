...
-- Players: Johan Andersson, Nicklas Jansson and Annika Persson
...
-- Delete jackets -- 
delete from jacket where playerId = (select personId from players where playerName = 'Johan Anderssons');
